...
import parse, { TOKEN } from "./util/parse.js";
import escape from "./util/escape.js";
import decodeEntities from "./util/decode-entities.js";
import { EMPTY, VTree, Supplemental } from "./util/types.js";
const {
  isArray
} = Array;
...
export default function handleTaggedTemplate(strings, ...values) {
  const empty = createTree('#text', EMPTY.STR); // Do not attempt to parse empty strings.
