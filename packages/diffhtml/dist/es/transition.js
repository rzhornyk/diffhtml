import { TransitionCache, NodeCache } from "./util/caches.js";
import process from "./util/process.js";
import { VTree, TransitionStateNames, TransitionStateName } from "./util/types.js";
/**
 *
...
export function runTransitions(setName, ...args) {
  ...
  set.forEach(callback => {
    const retVal = callback(NodeCache.get(vTree), ...rest); // Is a `thennable` object or Native Promise.
